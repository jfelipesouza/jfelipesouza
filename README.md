...
:computer: Para desenvolvimento web utilizo **ReactJs**,**Next.JS**; <br/>
:satellite: Desenvolvimento de API **NodeJs**; <br/>
:floppy_disk: Database: **Mongo**, **Firebase (Cloud Firestore/Real Time)**;<br/>
